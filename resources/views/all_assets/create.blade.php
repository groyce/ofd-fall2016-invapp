...
@section('content')
        ...
        <div class="panel-body">
            <div class="form-group">
                <select class="form-control" id="assets">
                    ...
                    <option id="23">Miscellaneous</option>
                    <option id="24">Default2</option>
                    <option id="25">Default3</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-default create" id="create-23" hidden>
        <div class="panel-heading">
    ...
    <div class="panel panel-default create" id="create-24" hidden>
        <div class="panel-heading">
            Create New Asset Type with Asset
        </div>
        <div class="panel-body">
            @include('asset.default2')
        </div>
    </div>

    <div class="panel panel-default create" id="create-25" hidden>
        <div class="panel-heading">
            Create New Default 3
        </div>
        <div class="panel-body">
            @include('asset.default3')
        </div>
    </div>
@stop
