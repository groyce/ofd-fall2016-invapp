{!! Form::model($all_assets,['method' => 'PUT', 'route' => ['all_assets.update', $all_assets->id], 'files' => true,]) !!}
    ...
    <div class="row">
        ...
        <div class="col-xs-6 form-group">
            ...
            {!! Form::text('date_issued', old('date_issued'), ['class' => 'form-control', 'placeholder' => 'YYYY-MM-DD']) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-xs-6 form-group">
        ...
        <div class="col-xs-6 form-group">
            ...
            {!! Form::text('date_matures', old('date_matures'), ['class' => 'form-control', 'placeholder' => 'YYYY-MM-DD']) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-xs-6 form-group">
