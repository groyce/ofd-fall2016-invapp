        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    {!! Form::text('date_issued', old('date_issued'), ['class' => 'form-control date', 'placeholder' => 'YYYY-MM-DD']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group">
                    ...
                    {!! Form::text('date_matures', old('date_matures'), ['class' => 'form-control date', 'placeholder' => 'YYYY-MM-DD']) !!}
                    <p class="help-block"></p>
